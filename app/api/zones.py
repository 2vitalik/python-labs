...
ZONES = {
    ...
    "game-logic": {"title": "Логіка гри", "icon": "🎲", "color": "#8e24aa", "subzones": {
    ...
    "code": {"title": "Код і платформа", "icon": "💻", "color": "#3949ab", "subzones": {
        "architecture": ("Архітектура", "🏛️"), "python": ("Python-фічі", "🐍"), "tests": ("Тести", "🧪"),
        "git": ("Git", "🔀"), "packaging": ("Пакування і запуск", "📦"),
    }},
    "support": {"title": "Супровід і промо", "icon": "📣", "color": "#d81b60", "subzones": {
