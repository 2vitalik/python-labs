...
- **Методичка переїздить на сайт** (2026-09-20, пропозиція — [T115](.t/T115-P--guide-on-site.md), питання — [T116](.t/T116-Q--guide-questions.md)): публічні сторінки `/labs` (+5 лаб), `/grading`, `/howto` + витяги на домашній і в шапках каталогів; тексти — Markdown у `data/guide/` (чернетки вже написані з Notion-експорту; лаби 2–5 у Notion були порожні — чернетки від тем лекцій), віддає API, якорі `{#id}` з підсвіткою цілі; редагування потім — Mongo + адмін-редактор. Передумова видимості для студентів — деплой.
...
- **Методичка на сайті** (2026-09-20): Vitalik — відповіді [T116](.t/T116-Q--guide-questions.md) (сторінки, домашня, відео, ліміти, лаби 2–5, деплой) + правка чернеток `data/guide/` (насамперед `lab2…5.md`, 🚧-місця); далі — гайд v1 у коді за планом [T115](.t/T115-P--guide-on-site.md) §7 (M) і деплой (M).
