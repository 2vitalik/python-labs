...
- **Дальня мета — лудопедія** (мрія Vitalik, 2026-08-17): єдина мова опису ігрового розмаїття без синтаксису; north star і мапа — [T98](games/.t/T98-B--ludopedia.md). Система лабораторних — перший мешканець цієї мови. **Будівництво стартувало** (2026-08-18, [T100](.rounds/.t/T100-R--ludopedia-kickoff.md) → [T101](platform/.t/T101--ludopedia-core/report.md)): сутності + правила-речення «КОЛИ→ТО» + інбокс знахідок `/refs` живі в пілоті; питання — [T102](games/.t/T102-Q--ludopedia-build-questions.md).
...
- **Лудопедія: перший шматок коду** (2026-08-18, [T100](.rounds/.t/T100-R--ludopedia-kickoff.md) → [T101](platform/.t/T101--ludopedia-core/report.md)): E1 сутності з ролями, правила-речення `Rule` (тригери contact/timer, 15 ефектів, редактор селектами), інбокс знахідок `/refs`; смоук 60/60. Vitalik: клік-тест нових секцій + [T102](games/.t/T102-Q--ludopedia-build-questions.md); [T97](games/.t/T97-Q--mechanics-session-questions.md)/[T99](games/.t/T99-Q--ludopedia-questions.md) — за бажанням формально. Далі: E2 слоти + E4 топ-20 · Д3 приклади на картках · раунд grading · заявки-гаманець ([T10](reports/.t/T10-Q--reports-open-questions.md)).
