...
- **Пілот «Моя гра»: етапи A–D закрито** ([T91](.t/T91--my-game-backend/report.md) + [T93](.t/T93--my-game-front/report.md) + [T94](.t/T94--passport-graph/report.md)) → Vitalik: великий клік-тест (граф зʼявляється, коли меню мають хост і цілі) + активувати `window`-картки після ревізії. Далі: сесія механік (T86 Q1c) · раунд grading (T08 Q1–Q2 є) · заявки-гаманець ([T10](../reports/.t/T10-Q--reports-open-questions.md)).
- Далі за [T25](../.t/T25-B--mvp-strategy.md) і планом [T87](../.rounds/.t/T87-R--game-round-decisions.md): етап D (паспорт+граф), сесія механік (E), заявки-гаманець (чекає рішень [T10](../reports/.t/T10-Q--reports-open-questions.md)).
