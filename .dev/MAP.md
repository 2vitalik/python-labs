...
Наступний вільний ID: **T137** · тікетів: 136 · дерево вузлів — [TREE.md](TREE.md)
...
|-------|----|---|------|--------|:-----:|
| .rounds | [T01](.rounds/.t/T01-R--braindump-readback.md) | ✔️ | braindump-readback | Рідбек стартового брейндампу | 🟢 ⬜ |
| — | [T02](.t/T02-P--node-structure.md) | 💡 | node-structure | Структура вузлів проєкту | 🟢 ⬜ |
...
| defense | [T12](defense/.t/T12-Q--defense-open-questions.md) | ❓ | defense-open-questions | Питання щодо захистів | 🔴 ⬜ |
...
| tgbot | [T20](tgbot/.t/T20-Q--tgbot-open-questions.md) | ❓ | tgbot-open-questions | Питання щодо бота | 🔴 ⬜ |
| platform | [T21](platform/.t/T21-B--tech-stack.md) | 🧠 | tech-stack | Вибір техстеку: бекенд, БД, фронтенд | 🟢 ⬜ |
| platform | [T22](platform/.t/T22-Q--platform-open-questions.md) | ❓ | platform-open-questions | Питання щодо платформи | 🔴 ⬜ |
| journal | [T23](journal/.t/T23-C--journal-concept.md) | 🔆 | journal-concept | Журнал викладача | 🟢 ⬜ |
...
| tgbot | [T109](tgbot/.t/T109-C--bot-message-style.md) | 🔆 | bot-message-style | Стиль повідомлень бота | 🟢 🟩 |
